  ...
  return (
    <div className="bg-white rounded-xl">
      <div className="w-full px-8 md:px-20 py-6">
        <h3 className="text-gradient-primary !font-bold text-center text-2xl md:text-3xl ">
          {t("title")}
        </h3>
      </div>
      <div className="px-6 md:px-8 lg:px-12 py-8 flex flex-col gap-4 items-center max-w-2xl mx-auto ">
        ...
        <div className="grid grid-cols-2 gap-4 w-full md:w-3/4">
          <button
            className="btn bg-white hover:bg-white/70 text-primary border-gradient-primary !rounded-full"
