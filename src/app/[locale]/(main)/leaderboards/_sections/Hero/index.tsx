    ...
    return (
      <>
        <div className="pt-5 px-4 sm:px-6 sm:pt-7 lg:px-8 lg:pt-4 z-10 relative">
          <div className="bg-[url('/images/leaderboard/leaderboard-bg-mobile.png')] bg-cover bg-center bg-no-repeat w-full min-h-[550px] rounded-2xl flex-center flex-col lg:bg-[url('/images/leaderboard/leaderboard-bg.png')] lg:aspect-[1303/861] xl:pb-30 2xl:pb-40">
