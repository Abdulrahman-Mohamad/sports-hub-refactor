...
export default function PackagesPurchaseModal({
  ...
  const renderStep=(step:modalStepType)=>{
    switch (step) {
      case "shipping":
        return <ShippingComponent setStep={setStep} paymentId={paymentId} promoResponse={promoResponse} pack={pack} onClose={onClose}/>
      case "operator":
        return <OperatorComponent setStep={setStep}/>
      case "otp":
        return <OtpComponent setStep={setStep} paymentId={paymentId} promoResponse={promoResponse} pack={pack}/>
      case "success":
        return <PackagesSuccessConponent onClose={onClose} />
      case "error":
        return <PackagesErrorComponent onClose={onClose}/>
    }
  }
