...
export type GoalDetails = "Normal Goal" | "Own Goal" | "Penalty" | "Missed Penalty";


export type CardDetails =  "Yellow Card" | "Red Card";

export type SubstDetails = "Substitution 1" | "Substitution 2" | "Substitution 3" | "Substitution 4" | "Substitution 5";
...
export interface FixtureOver extends FixtureProps {
    goals: {
        home:number;
        away:number;
    }
...
export interface HighlightsProps{
    ...
    fixture: FixtureOver;
    prediction:FixtureProps["prediction"];
}