      ...
      {isOpen && (
        ...
        >
          <motion.div
            ...
            className="rounded-lg px-2 py-4 w-[80vw] bg-darkMain border-gradient-greenblue glow-blue-green-notification relative
                        sm:py-6
                        md:w-[60vw] md:px-8
                        lg:w-[50vw] lg:px-12
                        xl:w-[40vw] xl:px-16"
          ...
          >
            ...
            <div className="flex gap-6 items-center">
              <div>
                <div className="p-2 my-auto border-4 border-primaryA1 rounded-full w-16 h-16 md:w-28 md:h-28 flex items-center justify-center">
                  <Image
              ...
              <div className="capitalize text-white space-y-1">
