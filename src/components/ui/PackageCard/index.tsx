  ...
  return (
    <>
      <div
        ...
        `}
      >
        <div className="bg-white rounded-xl flex flex-col items-center pb-20">
          {/* top */}
          ...
          {/* center */}
          <div
            className={`relative w-[calc(100%+48px)] aspect-[351/366]  bg-center bg-cover pt-10 pb-8 flex flex-col justify-end gap-4
              ${data.type === "vip" ? "text-white" : "text-black"}
              `}
            style={{
              backgroundImage: `url(/images/packages/${data.type === "vip" ? "vip" : data.type === "gold" ? "gold" : "silver"}.png)`,
            }}
          >
            ...
            <p
              className={`w-full text-center ${data.type !== "vip" ? "text-black/40" : "text-white/70"}`}
            >
              {t("not_refundable")}
            </p>
