            ...
            <div className="flex flex-col gap-4">
              <Link
                ...
                className={`text-neutral10 hover:font-black transition-all duration-200 ${
                  pathname === `/` && "font-black text-primary2"
                }`}
              >
                {t("home")}
              </Link>
              <Link
                href={`/packages`}
                className={`text-neutral10 hover:font-black transition-all duration-200 ${
                  pathname.includes("/packages") && " font-black text-primary2"
                }`}
              >
                {t("packages")}
              </Link>
              ...
              <Link
                href={`/games`}
                className={`text-neutral10 hover:font-black transition-all duration-200 ${
                  pathname.includes("/games") && " font-black text-primary2"
                }`}
              >
                {t("games")}
              </Link>
            ...
            <div className="flex flex-col gap-4">
              {user && (
                <Link
                  href={`/history`}
                  className={`text-neutral10 hover:font-black transition-all duration-200 ${
                    pathname.includes("/history") && " font-black text-primary2"
                  }`}
                >
                  {t("history")}
                </Link>
              ...
              <Link
                href={`/terms`}
                className={`text-neutral10 hover:font-black transition-all duration-200 ${
                  pathname.includes("/terms") && " font-black text-primary2"
                }`}
              >
                {t("terms")}
              </Link>
